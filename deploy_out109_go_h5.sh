...
check_keys "${CRED}" DATABASE_URL JWT_SECRET WECHAT_APP_ID WECHAT_APP_SECRET WECHAT_PAY_MCH_ID WECHAT_PAY_API_KEY
check_keys "${ACC}" HTTP_ADDR APP_ENV ENABLE_H5_TEST_LOGIN H5_TEST_DEFAULT_USER_ID WECHAT_PAY_USE_MOCK MINI_REVIEW_API_KEY PUBLIC_BASE_URL
