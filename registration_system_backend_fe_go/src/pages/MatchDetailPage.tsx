...
function rosterColumns(
...
): ColumnsType<MatchRegistrationEntry> {
  ...
  columns.push({
    title: "报名状态",
    dataIndex: "status",
    render: (value: MatchRegistrationStatus) => (
      <Tag color={registrationStatusColors[value]}>
        ...
        <>
          ...
          <section className="table-panel group-table-panel">
            <header className="panel-header">
              <div>
                <Text className="panel-kicker">REGISTRATION GROUPS</Text>
                <Title level={4}>报名组</Title>
              </div>
            </header>
              ...
              columns={[
                {
                  ...
                  dataIndex: "kind",
                  render: (value) =>
                    groupLabels[value as RegistrationGroup["kind"]],
                },
                {
                  title: "球队 ID",
                  dataIndex: "team_id",
          ...
          {(detail?.groups || []).map((group) => (
            <section key={group.id} className="table-panel roster-table-panel">
              <header className="panel-header">
                <div>
                  <Text className="panel-kicker">ROSTER</Text>
                  <Title level={4}>{groupLabels[group.kind]} · 队员报名</Title>
                </div>
              </header>
